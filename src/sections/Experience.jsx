                ...
                <div className='work-container'>
                    ...
                    <div className='work-content'>
                        <div className='sm:py-10 py-5 sm:px-5 px-2.5'>
                            {workExperiences.map(({name, pos,title,animation,id,duration,icon}, index) => (
                                <div key={id} className='work-content_container group' onClick={() => setAnimationName(animation.toLowerCase())} onPointerOver={() =>  setAnimationName(animation.toLowerCase())} onPointerOut={() => setAnimationName('idle')}>
                                    ...
                                    <div className='sm:p-5 px-2.5 py-5'>
                                        ...
                                        <p className='text-sm mb-5 text-gray-100'>{pos}--{duration}</p>
                                        <p className=' text-white group-hover:text-white transition ease-in-out duration-500'>{title}</p>
